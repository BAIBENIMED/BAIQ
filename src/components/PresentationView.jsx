    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ padding: '6px 12px', borderRadius: 8, background: 'linear-gradient(135deg, #2563eb, #7c3aed)', fontWeight: 900, fontSize: '0.82rem', letterSpacing: '0.08em' }}>
            BAIQ DAF EXECUTIVE
          </div>
          <div>
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            {Array.from({ length: totalSlides }).map((_, idx) => (
              <button
                ...
                style={{
                  width: idx === currentSlide ? 28 : 10, height: 10, borderRadius: 5,
      ...
      <main style={{ flex: 1, padding: '32px 48px', overflowY: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        {currentSlide === 0 && (
          <div style={{ animation: 'fadeIn 0.25s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
              <div>
                <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#60a5fa', textTransform: 'uppercase', letterSpacing: '0.08em' }}>SLIDE 1 / 4 · STRUCTURE FINANCIÈRE</span>
                <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#fff', margin: '4px 0 0' }}>Équilibre du Bilan &amp; Position de Trésorerie</h1>
              </div>
              <div style={{ padding: '8px 16px', borderRadius: 12, background: (bilan.tn || 0) >= 0 ? 'rgba(16,185,129,0.15)' : 'rgba(239,68,68,0.15)', border: `1px solid ${(bilan.tn || 0) >= 0 ? '#10b981' : '#ef4444'}`, color: (bilan.tn || 0) >= 0 ? '#34d399' : '#f87171', fontWeight: 800, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginBottom: 32 }}>
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Fonds de Roulement (FRNG)</span>
                <div style={{ fontSize: '2.2rem', fontWeight: 900, color: '#60a5fa', margin: '8px 0' }}>{fmt(bilan.frng)}</div>
                <div style={{ fontSize: '0.8rem', color: (bilan.frng || 0) >= 0 ? '#34d399' : '#f87171', fontWeight: 700 }}>
                  {(bilan.frng || 0) >= 0 ? 'Ressources stables excédentaires' : 'Emplois stables sous-financés'}
                </div>
              </div>

              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Besoin en Fonds de Roulement (BFR)</span>
                <div style={{ fontSize: '2.2rem', fontWeight: 900, color: '#f59e0b', margin: '8px 0' }}>{fmt(bilan.bfr)}</div>
              ...
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Trésorerie Nette (TN)</span>
                <div style={{ fontSize: '2.2rem', fontWeight: 900, color: (bilan.tn || 0) >= 0 ? '#34d399' : '#f87171', margin: '8px 0' }}>{fmt(bilan.tn)}</div>
                <div style={{ fontSize: '0.8rem', color: '#9ca3af', fontWeight: 700 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
              <div style={{ background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.2)', borderRadius: 14, padding: 20 }}>
                <h4 style={{ margin: '0 0 12px', fontSize: '0.92rem', color: '#93c5fd' }}>EMPLOIS DU BILAN (ACTIF)</h4>
        ...
        {currentSlide === 1 && (
          <div style={{ animation: 'fadeIn 0.25s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
              <div>
                <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#a78bfa', textTransform: 'uppercase', letterSpacing: '0.08em' }}>SLIDE 2 / 4 · PERFORMANCE ÉCONOMIQUE</span>
                <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#fff', margin: '4px 0 0' }}>Compte de Résultat &amp; Cascade des Marges</h1>
              </div>
              <div style={{ padding: '8px 16px', borderRadius: 12, background: 'rgba(124,58,237,0.15)', border: '1px solid #8b5cf6', color: '#c4b5fd', fontWeight: 800, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 20, marginBottom: 32 }}>
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: 20 }}>
                <span style={{ fontSize: '0.72rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Chiffre d'Affaires (CA)</span>
                <div style={{ fontSize: '1.6rem', fontWeight: 900, color: '#38bdf8', margin: '6px 0' }}>{fmt(sig.chiffreAffaires)}</div>
                <span style={{ fontSize: '0.72rem', color: '#64748b' }}>100.0 % de l'activité</span>
              </div>

              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: 20 }}>
                <span style={{ fontSize: '0.72rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Valeur Ajoutée (VA)</span>
                <div style={{ fontSize: '1.6rem', fontWeight: 900, color: '#818cf8', margin: '6px 0' }}>{fmt(sig.valeurAjoutee)}</div>
                <span style={{ fontSize: '0.72rem', color: '#a5b4fc', fontWeight: 700 }}>Taux VA : {fmtPct((sig.valeurAjoutee || 0) / (sig.chiffreAffaires || 1))}</span>
              </div>

              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: 20 }}>
                <span style={{ fontSize: '0.72rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Excédent Brut (EBE)</span>
                <div style={{ fontSize: '1.6rem', fontWeight: 900, color: '#34d399', margin: '6px 0' }}>{fmt(sig.ebe)}</div>
                <span style={{ fontSize: '0.72rem', color: '#6ee7b7', fontWeight: 700 }}>Marge EBE : {fmtPct((sig.ebe || 0) / (sig.chiffreAffaires || 1))}</span>
              </div>

              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: 20 }}>
                <span style={{ fontSize: '0.72rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Résultat Net (RN)</span>
                <div style={{ fontSize: '1.6rem', fontWeight: 900, color: (sig.resultatNet || 0) >= 0 ? '#34d399' : '#f87171', margin: '6px 0' }}>{fmt(sig.resultatNet)}</div>
                <span style={{ fontSize: '0.72rem', color: (sig.resultatNet || 0) >= 0 ? '#86efac' : '#fca5a5', fontWeight: 700 }}>Solde final distribuable</span>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 22 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
                <div>
                  <div style={{ fontSize: '0.72rem', color: '#9ca3af' }}>Personnel (Salaires 63)</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#f59e0b', marginTop: 3 }}>{fmt(sig.chargesPersonnel)}</div>
                  <div style={{ fontSize: '0.72rem', color: '#64748b' }}>{fmtPct((sig.chargesPersonnel || 0) / (sig.valeurAjoutee || 1))} de la VA</div>
                </div>
                <div>
                  <div style={{ fontSize: '0.72rem', color: '#9ca3af' }}>État &amp; Collectivités (64 + 69)</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#c084fc', marginTop: 3 }}>{fmt((sig.impotsTaxes || 0) + (sig.impotsSurResultats || 0))}</div>
                  <div style={{ fontSize: '0.72rem', color: '#64748b' }}>Taxes &amp; IBS</div>
                </div>
                <div>
                  <div style={{ fontSize: '0.72rem', color: '#9ca3af' }}>Prêteurs (Frais Fin. 66)</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#f87171', marginTop: 3 }}>{fmt(sig.chargesFinancieres)}</div>
                  <div style={{ fontSize: '0.72rem', color: '#64748b' }}>Charges financières</div>
                </div>
                <div>
                  <div style={{ fontSize: '0.72rem', color: '#9ca3af' }}>Autofinancement &amp; Amort.</div>
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#34d399', marginTop: 3 }}>{fmt(sig.dotationsAmortissements)}</div>
                  <div style={{ fontSize: '0.72rem', color: '#64748b' }}>Dépréciation du capital</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {currentSlide === 2 && (
          <div style={{ animation: 'fadeIn 0.25s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
              <div>
                <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#34d399', textTransform: 'uppercase', letterSpacing: '0.08em' }}>SLIDE 3 / 4 · COMPÉTITIVITÉ SECTORIELLE</span>
                <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#fff', margin: '4px 0 0' }}>Radar Sectoriel &amp; Délais d'Exploitation</h1>
              </div>
              <div style={{ padding: '8px 16px', borderRadius: 12, background: 'rgba(59,130,246,0.15)', border: '1px solid #3b82f6', color: '#93c5fd', fontWeight: 800, fontSize: '0.85rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 28, alignItems: 'center' }}>
              ...
              <div style={{ height: 320, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 12 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <RadarChart cx="50%" cy="50%" outerRadius="75%" data={radarData}>
                    ...
                    <Radar name="Votre Entreprise" dataKey="Entreprise" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.45} />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <div style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: 700 }}>Créances Clients (DSO)</div>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '0.68rem', color: '#64748b' }}>Norme Secteur</div>
                ...
                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <div style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: 700 }}>Dettes Fournisseurs (DPO)</div>
                ...
                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <div style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: 700 }}>Rotation des Stocks (DIO)</div>
        ...
        {currentSlide === 3 && (
          <div style={{ animation: 'fadeIn 0.25s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
              <div>
                <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#fbbf24', textTransform: 'uppercase', letterSpacing: '0.08em' }}>SLIDE 4 / 4 · ACCÈS AU FINANCEMENT</span>
                <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#fff', margin: '4px 0 0' }}>Rating de Crédit &amp; Capacité d'Emprunt</h1>
              </div>
              <div style={{ padding: '8px 20px', borderRadius: 12, background: solv.zoneBg, border: `1px solid ${solv.zoneBorder}`, color: solv.zoneColor, fontWeight: 900, fontSize: '1.1rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginBottom: 32 }}>
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Score Altman Z'' (EM-Score)</span>
                <div style={{ fontSize: '2.4rem', fontWeight: 900, color: solv.zoneColor, margin: '8px 0' }}>{solv.zScore.toFixed(2)}</div>
                <div style={{ fontSize: '0.78rem', color: '#9ca3af' }}>Probabilité de défaillance : <strong style={{ color: '#fff' }}>{solv.risqueDefaillance}</strong></div>
              </div>

              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#9ca3af', fontWeight: 700, textTransform: 'uppercase' }}>Score Banque d'Algérie</span>
                <div style={{ fontSize: '2.4rem', fontWeight: 900, color: solv.bancaire.ratingBAColor, margin: '8px 0' }}>
                  {solv.bancaire.scoreBA} <span style={{ fontSize: '1.2rem', color: '#64748b' }}>/ 20</span>
                </div>
                <div style={{ fontSize: '0.78rem', color: '#9ca3af' }}>Avis d'octroi de crédit : <strong style={{ color: solv.bancaire.ratingBAColor }}>{solv.bancaire.statutCredit}</strong></div>
              </div>

              <div style={{ background: 'rgba(37,99,235,0.12)', border: '1px solid rgba(37,99,235,0.3)', borderRadius: 16, padding: 24 }}>
                <span style={{ fontSize: '0.78rem', color: '#93c5fd', fontWeight: 800, textTransform: 'uppercase' }}>Capacité d'Emprunt Max (DZD)</span>
                <div style={{ fontSize: '2.0rem', fontWeight: 900, color: '#60a5fa', margin: '8px 0' }}>{fmt(solv.bancaire.capaciteEndettementMax)}</div>
                <div style={{ fontSize: '0.75rem', color: '#bfdbfe' }}>{'Plafond prudentiel bancaire (3.5 × EBE)'}</div>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 20 }}>
              <h4 style={{ margin: '0 0 8px', fontSize: '0.95rem', color: '#fff', display: 'flex', alignItems: 'center', gap: 8 }}>
                <span className="material-symbols-outlined" style={{ color: '#38bdf8' }}>fact_check</span>
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', fontSize: '0.75rem', color: '#9ca3af' }}>
