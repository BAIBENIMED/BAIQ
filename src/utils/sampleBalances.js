...
export const SAMPLE_BALANCES = [
  {
    ...
    title: 'CAS RÉEL : ENTREPRISE ALGÉRIE 2026',
    subtitle: 'Balance réelle d\'exploitation (130 comptes SCF)',
    secteurId: 'commerce_gros',
    effectif: 45,
    caN: '130 Comptes Réels',
    description: 'Balance réelle d\'entreprise algérienne (exercice 2026) avec comptes de liaison (181), investissements industriels (215/218), stocks matières (310), clients, fournisseurs et charges d\'exploitation.',
    badge: '🇩🇿 Réel Algérie 2026',
    badgeColor: '#2563eb',
  ...
  },
  {
    ...
    subtitle: 'Grande entreprise / Groupe industriel (780 comptes SCF)',
    secteurId: 'industrie_agro',
    effectif: 180,
    caN: '780 Comptes Détaillés',
    description: 'Balance d\'envergure complète avec 780 comptes SCF : parcs d\'usines, amortissements, provisions réglementées, impôts différés (133), immobilisations corporelles et sous-traitances.',
    badge: '🏭 Réel Groupe IBAI',
    badgeColor: '#059669',
